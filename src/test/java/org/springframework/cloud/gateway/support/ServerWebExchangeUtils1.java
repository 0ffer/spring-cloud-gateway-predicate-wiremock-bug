...
/**
 * FIXME Перенесен из основной библиотеки из-за недоработок в api.
 *       Не работал совместно с wiremock. Сделаны модификации для возможности работы.
 * @author Spencer Gibb
 */
public final class ServerWebExchangeUtils1 {

    private static final Log log = LogFactory.getLog(ServerWebExchangeUtils1.class);
    ...
    private ServerWebExchangeUtils1() {
        throw new AssertionError("Must not instantiate utility class.");
    }

    private static String qualify(String attr) {
        return ServerWebExchangeUtils1.class.getName() + "." + attr;
    }
